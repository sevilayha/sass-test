...
"use strict";var client=algoliasearch("4KRGXPTF7K","4594f3b07157188f25b3f5a8a7eba04e"),guides=client.initIndex("guides_production"),courses=client.initIndex("courses_production"),posts=client.initIndex("posts_production"),options={hitsPerPage:10,distinct:5,facetFilters:["status:published"]};autocomplete("#aa-search-input",{openOnFocus:!0,keyboardShortcuts:["s","/"],templates:{dropdownMenu:'\n      <div class="aa-dataset-container">\n        <div class="aa-dataset-column">\n          <div class="aa-dataset-guides"></div>\n          <div class="aa-dataset-courses"></div> \n        </div>\n        <div class="aa-dataset-column">\n          <div class="aa-dataset-posts"></div>\n        </div>\n      </div>\n      '}},[{source:autocomplete.sources.hits(guides,options),displayKey:"name",name:"guides",templates:{header:'<div class="aa-suggestions-header aa-suggestions-category">Guides</div>',suggestion:function(s){return"<span>"+s._highlightResult.title.value+"</span>"},empty:'<div class="aa-empty">No matching guides</div>'}},{source:autocomplete.sources.hits(courses,options),displayKey:"name",name:"courses",templates:{header:'<div class="aa-suggestions-header aa-suggestions-category">Courses</div>',suggestion:function(s){return"<span>"+s._highlightResult.title.value+"</span>"},empty:'<div class="aa-empty">No matching courses</div>'}},{source:autocomplete.sources.hits(posts,options),displayKey:"name",name:"posts",templates:{header:'<div class="aa-suggestions-header aa-suggestions-category">Posts</div>',suggestion:function(s){return"<span>"+s._highlightResult.title.value+"</span>"},empty:'<div class="aa-empty">No matching posts</div>'}}]).on("autocomplete:selected",function(s,e,t){var a=void 0;"guides"===t?a="https://school.scotch.io/guides/"+e.slug:"courses"===t?a="https://school.scotch.io/courses/"+e.slug:"posts"===t&&(a=e.published_url),window.location.href=a});